...
ENV ORACLE_VERSION=SE2 \
    ...
    ORACLE_HOME=/u01/oracle/product/12.1.0.2/dbhome_1

# Environment variables required for this build (do NOT change)
# -------------------------------------------------------------
ENV DB_FILE_1="linuxamd64_12102_database_se2_1of2.zip" \
    DB_FILE_2="linuxamd64_12102_database_se2_2of2.zip" \
    DB_RSP="install.rsp" \
...
COPY $SOFTWARE_HOME/$DB_FILE_2 $INSTALL_DIR/
