...
function createDB {
   ...
   cp $SCRIPTS_HOME/$CONFIG_RSP $SCRIPTS_HOME/dbca.rsp

   sed -i -e "s|###ORACLE_SID###|$ORACLE_SID|g" $SCRIPTS_HOME/dbca.rsp
   sed -i -e "s|###ORACLE_PDB###|$ORACLE_PDB|g" $SCRIPTS_HOME/dbca.rsp
   sed -i -e "s|###ORACLE_PWD###|$ORACLE_PWD|g" $SCRIPTS_HOME/dbca.rsp
...
# Start LISTENER and run DBCA
   lsnrctl start &&
   dbca -silent -responseFile $SCRIPTS_HOME/dbca.rsp ||
